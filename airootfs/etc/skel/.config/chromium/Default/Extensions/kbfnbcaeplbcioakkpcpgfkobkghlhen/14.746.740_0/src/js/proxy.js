!function e(t, n, o) {
    ...
    39: [ function(e, t, n) {
        ...
        t.exports = function(e, t, n, b, m, y, L) {
            ...
            }, O = t + " Iterator", R = m == h, N = !1, F = e.prototype, I = F[d] || F[p] || m && F[m], A = I || k(m), E = m ? R ? k("entries") : A : void 0, C = "Array" == t ? F.entries || I : I;
            if (C && (w = f(C.call(new e())), w !== Object.prototype && (l(w, O, !0), o || c(w, d) || s(w, d, v))), 
            R && I && I.name !== h && (N = !0, A = function() {
                return I.call(this);
            }), o && !L || !g && !N && F[d] || s(F, d, A), a[t] = A, a[O] = v, m) if (x = {
                values: R ? A : k(h),
                keys: y ? A : k(_),
                entries: E
    ...
    77: [ function(e, t, n) {
        ...
        var o, r, i, s = e("./_library"), c = e("./_global"), a = e("./_ctx"), u = e("./_classof"), l = e("./_export"), f = e("./_is-object"), d = e("./_a-function"), g = e("./_an-instance"), p = e("./_for-of"), _ = e("./_species-constructor"), h = e("./_task").set, v = e("./_microtask")(), b = "Promise", m = c.TypeError, y = c.process, L = c[b], y = c.process, x = "process" == u(y), j = function() {}, w = !!function() {
            ...
            if (!e._n) {
                ...
                v(function() {
                    for (var o = e._v, r = 1 == e._s, i = 0, s = function(t) {
                        ...
                        try {
                            s ? (r || (2 == e._h && C(e), e._h = 1), s === !0 ? n = o : (u && u.enter(), n = s(o), 
            ...
            h.call(c, function() {
                ...
                }), e._h = x || E(e) ? 2 : 1), e._a = void 0, t) throw t.error;
            });
        }, E = function(e) {
            if (1 == e._h) return !1;
        ...
        w || (L = function(e) {
            ...
            var e = new o();
            this.promise = e, this.resolve = a(M, e, 1), this.reject = a(P, e, 1);
        }), l(l.G + l.W + l.F * !w, {
            Promise: L
    ...
    80: [ function(e, t, n) {
        ...
        function c() {
            return s() && navigator.userAgent.indexOf("Version/8.0") !== -1;
        }
        function a() {
        ...
        function d() {
            return i() ? "chrome" : r() ? "firefox" : s() ? "safari" : "other";
        }
        function g() {
            return p ? p.config.modules.parameters.version : "unknown";
        }
        var p = window.forge;
        n.isWE = o, n.isFF = r, n.isChrome = i, n.isSafari = s, n.isSafari8 = c, n.isWindows = a, 
        n.isBg = u, n.isPopup = l, n.isBgOrPopup = f, n.getBrowser = d, n.getVersion = g, 
        n.ENV = "prod";
        ...
        var v = "https://app." + n.GRAMMARLY_DOMAIN, b = "https://auth." + n.GRAMMARLY_DOMAIN + "/v3", m = b + "/user", y = h + "/after_install_page";
        n.URLS = {
            app: v,
            appPersonalDictionary: v + "/profile/dictionary",
            capi: "wss://capi." + n.GRAMMARLY_DOMAIN + "/freews",
            dapiMimic: n.DAPI + "/api/mimic",
            dapiProps: n.DAPI + "/api/props",
            editorDictionary: v + "/profile/dictionary",
            dictionary: "https://capi." + n.GRAMMARLY_DOMAIN + "/api/defs",
            docs: v + "/docs",
            docsApi: "https://dox." + n.GRAMMARLY_DOMAIN + "/documents",
            authSettings: m + "/settings",
            authCreatePage: b + "/redirect-anonymous?location=" + y,
            userOrAnonymous: m + "/oranonymous",
            authSignin: b + "/login",
            authSignup: b + "/signup",
            signin: h + "/signin",
            signup: h + "/signup",
        ...
        var L = d().slice(0, 1).toUpperCase() + d().slice(1);
        n.appName = "extension" + L, n.gnarAppName = d() + "Ext";
    }, {} ],
    81: [ function(e, t, n) {
        "use strict";
        function o(e) {
        ...
        function r(e, t, n, o, r, s, a, u) {
            var l = {
                message: s,
                logger: r,
                level: i.toFelogString(a),
                application: e,
                version: t,
                env: n
            };
            return u && (l.extra = u), o + "/log?json=" + encodeURIComponent((0, c["default"])(l));
        }
        var i, s = e("babel-runtime/core-js/json/stringify"), c = o(s);
        !function(e) {
            ...
            e.toFelogString = t;
        }(i = n.LogLevel || (n.LogLevel = {})), n.felogRequestUrl = r;
    }, {
    ...
    82: [ function(e, t, n) {
        ...
        var i = e("babel-runtime/core-js/promise"), s = o(i), c = e("../newConfig"), a = e("./felog");
        n.sendEventPixel = r;
    }, {
        "../newConfig": 80,
        "./felog": 81,
    ...
    83: [ function(e, t, n) {
        ...
        var r = e("babel-runtime/core-js/json/stringify"), i = o(r), s = e("babel-runtime/helpers/classCallCheck"), c = o(s), a = e("babel-runtime/helpers/createClass"), u = o(a), l = e("./felog"), f = function() {
            function e(t) {
                var n = this;
                (0, c["default"])(this, e), this._sendFelog = t, this.pageLoadTimeout = function() {
                    ...
                    n._send("bg.settings.weakDialect.init", "set weak dialect from capi", l.LogLevel.INFO, {
                        dialect: e
                    });
                    ...
                    n._send("bg.state.dialect.weak.initialize", "set weak dialect from dapi", l.LogLevel.INFO);
    ...
    84: [ function(e, t, n) {
        ...
        var i = e("babel-runtime/helpers/defineProperty"), s = o(i), c = e("babel-runtime/core-js/object/assign"), a = o(c), u = e("lib/tracking/felogPixel"), l = e("lib/tracking/telemetry"), f = [ "bridge", "message:to-priv", "message:to-non-priv" ], d = window.chrome || window.browser, g = new l.Telemetry(u.sendEventPixel);
        ...
        "lib/tracking/felogPixel": 82,
        "lib/tracking/telemetry": 83
    } ]
}, {}, [ 84 ]);