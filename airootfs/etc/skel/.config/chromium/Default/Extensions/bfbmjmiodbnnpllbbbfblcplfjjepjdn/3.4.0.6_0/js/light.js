...
if (y == "auto"){}
else{x[i].classList.add('stefanvdvideoauto');}
}
}
}
...
do {
	...
	if (yta == "auto"){}
	else{el.classList.add('stefanvdvideoauto');}
} while ((el.nodeName.toLowerCase() != 'html') && (el = el.parentNode))
...
embedplayer[i].style.cssText = 'visibility:visible !important; position:relative !important; z-index:1001 !important;' + 'height:' + Math.round(spar) + 'px; width:' + Math.round(been) + 'px; display: block;';
//embedplayer[i].style.cssText = 'visibility:visible !important; position:relative !important; z-index:1001 !important';
}
}
